  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center bg-char-900 px-6 py-16">
      <div className="w-full max-w-sm">
        <p className="text-center text-sm text-ember-400">Welcome back</p>
        <h1 className="mt-2 text-center font-display text-3xl text-cream">Log In</h1>
        ...
        <p className="mt-6 text-center text-sm text-parchment/60">
          New here?{" "}
          <Link href="/signup" className="text-ember-400 underline underline-offset-4">
            Create an account
          </Link>
        </p>
      </div>
